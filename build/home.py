...
class HomePage(QMainWindow):
    ...
    def setup_ui(self):
        ...
        description_label2 = QLabel("Welcome to the tutorials page for Cyber-Cipher!")
        ...
        description_para2.setHtml('''
               ...
               <br> 
                ...
                Get ready to explore the world of encryption and decryption with <b><i>Cyber-Cipher</i>, where security meets simplicity</b>.<br>
                <br>
