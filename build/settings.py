...
#         twitter.clicked.connect(lambda: webbrowser.open("https://twitter.com/"))
#         email = CustomButton("Mail", min_size=(100,40),max_size=(100,40))
#         email.clicked.connect(lambda: webbrowser.open("mailto:?to=@gmail.com&subject=Feedback%20for%20SecureCipher&body="))
...
#         about_text.setHtml(
#         '''
#         Hey there! 👋 Thanks for checking out Secure Cipher! I'm <b>Dev patel </b> ,the sole developer behind this project. <br>
